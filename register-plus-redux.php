...
/*
Author: Bernice Ling
Plugin Name: Neyrinck Register 
Description: Based on Rgister Plus Redux. Heavily customized. DO NOT UPDATE.
*/
...
if ( !class_exists( 'Register_Plus_Redux' ) ) {
	class Register_Plus_Redux {
		...
		public /*.void.*/ function send_verification_mail( /*.int.*/ $user_id, /*.string.*/ $verification_code ) {
			...
			$verificationURL =  get_site_url().'/login?action=verifyemail&verification_code='.$verification_code;
			include 'email.php';
